...
function _defineProperty(e, i, r) { return i in e ? Object.defineProperty(e, i, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[i] = r, e }! function(l) {
    var e, r = l(".active-sticky");
    l(window).on("scroll", function() {
        var e = l(window).scrollTop(),
            i = r;
        e < 1 ? (i.removeClass("is-sticky"), l("#scrollUp").removeClass("show")) : (i.addClass("is-sticky"), l("#scrollUp").addClass("show"))
    }), l("#offcanvasNav a").on("click", function() {
        var e = l(this),
            i = e.closest("ul"),
            r = i.find(".active"),
            s = e.closest("li"),
            e = s.hasClass("active"),
            t = 0;
        i.find("ul").slideUp(function() {++t == i.find("ul").length && r.removeClass("active") }), e || (s.children("ul").slideDown(), s.addClass("active"))
    }), l("#shop-dropdown a").on("click", function() {
        var e = l(this),
            i = e.closest("ul"),
            r = i.find(".active"),
            s = e.closest("li"),
    ...
    }), l("#currentYear").text((new Date).getFullYear()), l.scrollUp({ scrollName: "scrollUp", scrollDistance: 200, scrollFrom: "top", scrollSpeed: 400, easingType: "linear", animation: "fade", animationSpeed: 200, scrollTrigger: !1, scrollTarget: !1, scrollText: '<i class="ion-android-arrow-up"></i>', scrollTitle: !1, scrollImg: !1, activeOverlay: !1, zIndex: 214 })
}(jQuery);